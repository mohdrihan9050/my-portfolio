            ...
            <div className="row g-3 m-3">
                <div className="c-card col-lg-4 col-md-4 col-sm-12 col-12">
                    <div data-aos="zoom-out" className="card">
                            ...
                            <a className='ms-2 mt-1' href="https://www.coursera.org/account/accomplishments/verify/XJ7YGJ4CX23E">see credential</a>
                    </div>
                </div>
                ...
                <div className="c-card col-lg-4 col-md-4 col-sm-12 col-12">
                    <div data-aos="zoom-out" className="card">
                            ...
                            <a className='ms-2' href="https://www.freecodecamp.org/certification/mohdrihanzi786/responsive-web-design">see credential</a>
                    </div>
                </div>
                ...
                <div className="c-card col-lg-4 col-md-4 col-sm-12 col-12">
                    <div data-aos="zoom-out" className="card">
                            ...
                            <a className='mt-3 ms-2' href="https://verify.letsupgrade-in/certificate/LUECPFEB123400">see credential</a>
                    </div>
                </div>
            </div>
        </div>
